...
import com.pushpushgo.sdk.inapp.model.InAppMessageDescription
import com.pushpushgo.sdk.inapp.model.InAppMessageStyle
import com.pushpushgo.sdk.inapp.model.InAppMessageTitle
...
internal fun createFontFamily(message: InAppMessage): FontFamily {
  ...
  val fontName =
    when (message.style.fontFamily) {
      com.pushpushgo.sdk.inapp.model.FontFamily.ROBOTO -> "Roboto"
      com.pushpushgo.sdk.inapp.model.FontFamily.OPEN_SANS -> "Open Sans"
      com.pushpushgo.sdk.inapp.model.FontFamily.MONTSERRAT -> "Montserrat"
      com.pushpushgo.sdk.inapp.model.FontFamily.INTER -> "Inter"
      com.pushpushgo.sdk.inapp.model.FontFamily.POPPINS -> "Poppins"
      com.pushpushgo.sdk.inapp.model.FontFamily.LATO -> "Lato"
      com.pushpushgo.sdk.inapp.model.FontFamily.PLAYFAIR_DISPLAY -> "Playfair Display"
      com.pushpushgo.sdk.inapp.model.FontFamily.FIRA_SANS -> "Fira Sans"
      com.pushpushgo.sdk.inapp.model.FontFamily.ARIAL -> "Roboto"
      com.pushpushgo.sdk.inapp.model.FontFamily.GEORGIA -> "Gelasio"
    }
    ...
    fontWeights.flatMap { weight ->
      fontStyles.map { style ->
        Font(
          ...
          style =
            if (style == com.pushpushgo.sdk.inapp.model.FontStyle.ITALIC) {
              FontStyle.Italic
            } else {
              FontStyle.Normal
            },
...
@Composable
internal fun PaddingValues.add(add: Dp): PaddingValues =
  PaddingValues(
