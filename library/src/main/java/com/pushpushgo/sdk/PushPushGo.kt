...
class PushPushGo private constructor(
  ...
  companion object {
    ...
    @JvmStatic
    fun getInstance(): PushPushGo = INSTANCE ?: throw PushPushException("You have to initialize PushPushGo with context first!")
    ...
    private fun extractCredentialsFromContext(context: Context): Pair<String, String> {
      ...
      val apiKey =
        bundle.getString("com.pushpushgo.apikey")
          ?: throw PushPushException("You have to declare apiKey in Your Manifest file")
      val projectId =
        bundle.getString("com.pushpushgo.projectId")
