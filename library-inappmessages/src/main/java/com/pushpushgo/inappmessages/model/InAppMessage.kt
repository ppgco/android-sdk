...
// --- Enums ---
enum class UserAudienceType {
    @Json(name = "ALL") ALL,
    @Json(name = "SUBSCRIBER") SUBSCRIBER,
    @Json(name = "NON_SUBSCRIBER") NON_SUBSCRIBER,
    @Json(name = "NOTIFICATIONS_BLOCKED") NOTIFICATIONS_BLOCKED
}
...
enum class OSType {
    ...
    @Json(name = "IOS") IOS,
    @Json(name = "WINDOWS") WINDOWS,
    @Json(name = "MACOS") MACOS,
    @Json(name = "HARMONY") HARMONY,
    @Json(name = "OTHER") OTHER
}
